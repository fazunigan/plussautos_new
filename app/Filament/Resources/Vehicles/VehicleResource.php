...
use App\Filament\Resources\Vehicles\RelationManagers\InspectionItemsRelationManager;
...
class VehicleResource extends Resource
{
    ...
    {
        return (string) Vehicle::query()->listable()->count();
    }

    public static function getNavigationBadgeTooltip(): ?string
    {
        return 'Publicados en el catálogo';
    }
    ...
    {
        return [
            InspectionItemsRelationManager::class,
        ];
    }
